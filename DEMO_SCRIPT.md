...
- **Specialty accelerator — the proof** → point at **Cardiology** (echocardiogram → 93306, ECG → 93000)
  ...
  *"Both were added with no pipeline changes — just their codes, a few knowledge-graph concepts, payer
  ...
  does cardiac, ortho, women's health, GI endoscopy and dermatology, and the Evaluation Harness already
  scores them. That's how ten specialties — Radiology, E&M, ED, Pathology, Surgical, Cardiology,
  Orthopedics, OB/GYN, GI / Endoscopy and Dermatology — run on one accelerator. New specialties are
